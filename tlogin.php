<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM teacher WHERE user = '$myusername' and pass = '$mypassword'";
...
<body>
        ...
        <h1>TEACHER CREDENTIALS</h1>
                ...
                <form method="POST" action="tlogin.php">
                        USERNAME: <input type = "text" name="suser" id="suser"/><br><br>
                        PASSWORD: <input type = "password" name="spass" id="spass"/><br><br>
